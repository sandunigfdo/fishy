                                                            ...
                                                            <div class="flex space-x-10">
                                                                ...
                                                                <div>
                                                                    <form method="POST" action="{{ route('campaign.destroy', $campaign) }}">
                                                                        ...
                                                                        @method('delete')
                                                                            <button type="submit"
                                                                                    onclick="return confirm('Are you sure you want to delete this campaign? Related results will also be removed and can not be recovered after this action.');"
                                        ...
                                        <div class="sm:col-span-6">
                                            ...
                                            <div class="mt-2">
                                                <input id="name"
                                                       name="name"
                                                       type="text"
                                                       placeholder="Create a new Campaign"
                                                       required
                                        ...
                                        <div id="employees-container" class="sm:col-span-6 mt-2">
                                            <template x-for="employee in employees" :key="employee.id">
                                                <div class="flex gap-4 mb-4">
                                                    ...
                                                    <div class="flex-1">
                                                        <label :for="'e_email-' + employee.id"
                                                            class="block text-sm font-medium leading-6 text-gray-900">
                                                            Email
                                                        </label>
                                                        <div class="mt-2">
                                                            <input type="text"
                                                                :name="'e_email-' + employee.id"
                                                                :id="'e_email-' + employee.id"
                                                                x-bind:value="employee.email"
                                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                        </div>
                                                    </div>
                                                </div>
